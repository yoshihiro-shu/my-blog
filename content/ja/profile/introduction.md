...
大学卒業後、株式会社ZUUにて金融メディアの開発・運用・保守に従事した後、現在はGMOペパボ株式会社にてソフトウェアエンジニアとして勤務しております。Go言語を中心としたバックエンド開発を軸に、要件定義から設計・実装・リリースまでを一貫して経験しております。
また、チームビルディングやプロジェクトマネジメントの経験もあります。

詳しくは[職務経歴書](/resume)をご覧ください。
